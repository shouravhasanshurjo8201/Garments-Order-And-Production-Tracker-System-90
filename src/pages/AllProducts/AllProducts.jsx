...
//     // Memoizing the fetch function stabilizes its identity across renders
...
//         } catch (error) {
//             // Variable name matches the caught exception object exactly now
...
//     // fetchProducts is now a safe dependency because it is wrapped in useCallback
//     useEffect(() => {
//         fetchProducts();
//     }, [fetchProducts]);
...
//                                         ? "bg-lime-50 text-white shadow shadow-lime-200"
        ...
        <Container>
            <div>
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto">
                        Search and filter through our latest
                        garments production batch with real-time
                        stock status.
                    </p>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                        <div className="md:col-span-5 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-11 pr-4 py-3 border border-gray-500/50 rounded-2xl focus:ring-2 focus:ring-lime-400 outline-none"
                            />
                        </div>
                ...
                {totalPages > 1 && (
                    <div className="flex justify-center items-center gap-3 mt-16">
                        <button
                            ...
                            className="px-5 py-2 rounded-xl font-bold border disabled:opacity-50"
                        >
                            Previous
                        </button>
                        ...
                        <div className="flex gap-2">
                            {Array.from(
                                ...
                                <button
                                    ...
                                    className={`w-10 h-10 rounded-xl font-bold ${currentPage === page
