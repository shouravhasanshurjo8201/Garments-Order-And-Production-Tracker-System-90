        ...
        <div className="-mt-16 pb-5 overflow-hidden">
            <Container>
                ...
                >
                    <div className="relative z-10">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black  mb-6 leading-tight">
                            Garments Order & <br />
                            <span className="text-lime-600 underline decoration-lime-700 decoration-4">Production Tracker System</span>
                        </h2>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    <motion.div
                        {...fadeInUp}
                        className=" p-10 rounded-[3rem] shadow border border-green-500/50 group"
                    >
                        <div className="w-14 h-14 bg-green-600 text-white rounded-2xl flex items-center justify-center mb-6 shadow shadow-green-200 group-hover:rotate-12 transition-transform">
