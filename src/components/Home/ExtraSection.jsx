            ...
            <div className="container mx-auto p-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8">
                    {partners.map((p, i) => (
                        <motion.div
                            key={i}
                            className="group relative flex items-center justify-center p-8  rounded-2xl border border-gray-500/40 hover:border-lime-200  hover:shadow transition-all duration-500"
                        ...
                        >
                            <img
                                src={p.logo}
                                alt={p.name}
                                className="w-full h-12 md:h-14 object-contain filter group-hover:grayscale-0 opacity-60 group-hover:opacity-100 transition-all duration-500"
                            />
