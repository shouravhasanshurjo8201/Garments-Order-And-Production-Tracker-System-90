      ...
      <div className="container mx-auto px-6">
        <header className="mb-14 text-center space-y-5">
          <h2 className="text-3xl md:text-5xl font-black leading-[1.1] tracking-tight">
            Growing Trust, <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-lime-600 to-green-500">One Leaf at a Time.</span>
          </h2>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-20">
          ...
          >
            ...
            <div className="relative group">
              ...
              >
                <div className="bg-linear-to-br from-lime-400 to-lime-600 p-3.5 rounded-2xl text-white shadow-lg shadow-lime-500/20">
                  <ThumbsUp size={24} />
                </div>
                <div>
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              {features.map((f, i) => (
                ...
                >
                  <div className={`w-14 h-14 ${f.iconBg} rounded-2xl flex items-center justify-center mb-6 transition-transform duration-500 group-hover:rotate-360`}>
                    {f.icon}
                  </div>
