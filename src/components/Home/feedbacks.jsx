                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                    ...
                                    <div key={i} className="outline-none py-4">
                                        <div className=" backdrop-blur-sm border border-gray-400/40 p-8 md:p-10 rounded-xl shadow-sm">
                                            ...
                                            <div className="flex items-center gap-4 border-t border-gray-400/40 pt-6">
                                                <div className="w-14 h-14  rounded-full flex items-center justify-center text-xl font-bold shadow shadow-lime-200">
                                                    {fb.name[0]}
                                                </div>
                                                <div>
                    ...
                    >
                        ...
                        <div className="relative group">
                            ...
                            >
                                <div className="w-12 h-12 bg-lime-50 text-lime-600 rounded-full flex items-center justify-center font-black">
                                    4.9
                                </div>
                                <div className="pr-2">
